...
class NotificationScreenLender extends StatefulWidget {
  String userId = "";
  String popText = "";
  ...
  @override
  _NotificationScreenLenderState createState() => _NotificationScreenLenderState();
}

class _NotificationScreenLenderState extends State<NotificationScreenLender> {
  bool isInit = true;
  int filter = 0;
      ...
      try {
        List<Transaction> newTransactions =
            await Provider.of<TransactionProvider>(context, listen: false)
                .getLenderTransactions(getuserId);
        setState(() {
          isInit = false;
                ...
                : ListView.builder(
                    itemBuilder: (ctx, index) {
                      return PendingCard(
                        ...
                        isMyRequest: false,
                        name: widget.filteredTransactions[index].requesterName,
