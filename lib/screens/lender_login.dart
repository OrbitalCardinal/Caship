...
class LenderLoginScreen extends StatefulWidget {
  static const routeName = 'lenderLogin';
  @override
  _LenderLoginScreenState createState() => _LenderLoginScreenState();
}
                ...
                children: [
                  RichText(
                    text: TextSpan(
                        ...
                        children: [
                          TextSpan(
                              text: " " + AppLocalizations.of(context).lender,
                              style: TextStyle(
                  ...
                  Container(
                    ...
                    child: Image(
                      image: AssetImage('assets/imgs/login2.png'),
                      width: 150,
                    ),
                  ),
                  SizedBox(
                        ...
                        decoration: InputDecoration(
                          suffixIcon: GestureDetector(
                            ...
                            child: Icon(
                              ...
                              color: obscure ? Colors.grey : primaryColor,
                            ),
                          ),
